...
def shield_f1(bl):
    return lambda x: 1 + 0.02 * (x - bl) ** 1.75


def shield_f2(bl):
    return lambda x: 1 + 1.6 * (x - bl) ** 0.75
...
def eximus_health(bl):
    def f(x):
        x -= bl
        y = normal_health(0)(x)  # x <= 25
        y[25 < x] = (1.0 + 0.05 * (x[25 < x] - 25)) * normal_health(0)(x[25 < x])
        y[35 < x] = (1.5 + 0.10 * (x[35 < x] - 35)) * normal_health(0)(x[35 < x])
        y[50 < x] = (3.0 + 0.02 * (x[50 < x] - 50)) * normal_health(0)(x[50 < x])
        y[100 < x] = 4 * normal_health(0)(x[100 < x])
        x += bl
        return y
...
def eximus_armor(bl):
    def f(x):
        x -= bl
        y = normal_armor(0)(x)  # x <= 25
        y[25 < x] = (1.0 + 0.0125 * (x[25 < x] - 25)) * normal_armor(0)(x[25 < x])
        y[35 < x] = (1.125 + (x[35 < x] - 35) / 60) * normal_armor(0)(x[35 < x])
        y[50 < x] = (1.375 + 0.005 * (x[50 < x] - 50)) * normal_armor(0)(x[50 < x])
        y[100 < x] = 1.625 * normal_armor(0)(x[100 < x])
        x += bl
        return y
